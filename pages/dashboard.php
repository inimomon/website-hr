...
.modal-content {
    ...
    top: 15%;                /* Adjust as per your needs */
    left: 35%;               /* This is to center the modal if its width is 30%. Adjust as per your needs. */
    background-color: #fefefe;
    padding: 20px;
    border: 1px solid #888;
    width: 30%; 
    z-index: 100;           /* High value to ensure it's on top. You can adjust this value. */
}
...
.close:focus {
    ...
    cursor: pointer;
        ...
        .lineBarNikah {
            width: 400px;
            max-width: 400px; /* Adjust for your preference */
            height: 20px; /* Height of the bar */
            background-color: rgba(220, 220, 220, 0.2); /* Light grey background to see the full bar */
            display: flex;
        }

        .married {
            flex: <?php echo $menikah?>; /* This represents the 32% */
            background-color: rgba(255, 99, 132, 0.6); /* Color for Married */
        }

        .notMarried {
            flex: <?php echo $belumMenikah?>; /* This represents the 68% */
            background-color: rgba(54, 162, 235, 0.6); /* Color for Not Married */
        }

        .cowo {
            flex: <?php echo $cowo?>; /* This represents the 32% */
            background-color: rgba(255, 99, 132, 0.6); /* Color for Married */
        }

        .cewe {
            flex: <?php echo $cewe?>; /* This represents the 68% */
            background-color: rgba(54, 162, 235, 0.6); /* Color for Not Married */
        }
  </style>
</head>
<body class="g-sidenav-show" style="background-color: rgb(239, 239, 239);">
    ...
    <!-- End Navbar -->
      <div class="row mt-4">
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div id="bar-container">
                            ...
                            <div class="lineBarNikah" style="height: 30px; margin-bottom: 10px;">
                                <div class="married" title="Married: <?php echo $percentages['Menikah']; ?>%"></div>
                                <div class="notMarried" title="Not Married: <?php echo $percentages['Belum']; ?>%"></div>
                            </div>
                            
                            <!-- Legend -->
                            <div class="legend mt-4" style="display: flex; align-items: center; gap: 10px;">
                                <div class="color-box" style="width: 20px; height: 20px; background-color: rgba(255, 99, 132, 0.6);"></div>
                                <span>Menikah: <?php echo $menikah; ?>%</span>
                            </div>
                            <div class="legend" style="display: flex; align-items: center; gap: 10px;">
                                <div class="color-box" style="width: 20px; height: 20px; background-color: rgba(54, 162, 235, 0.6);"></div>
                                <span>Belum Menikah: <?php echo $belumMenikah; ?>%</span>
                            </div>
                        </div>
                  </div>
                </div>
        ...
        <div class="col-lg-6">
          ...
          <div id="bar-container">
                            <div class="lineBarNikah" style="height: 30px; margin-bottom: 10px;">
                                <div class="cowo" title="Married: 32%"></div>
                                <div class="cewe" title="Not Married: 68%"></div>
                            </div>
                            
                            <!-- Legend -->
                            <div class="legend mt-4" style="display: flex; align-items: center; gap: 10px;">
                                <div class="color-box" style="width: 20px; height: 20px; background-color: rgba(255, 99, 132, 0.6);"></div>
                                <span>Laki-laki: <?php echo $cowo; ?>%</span>
                            </div>
                            <div class="legend" style="display: flex; align-items: center; gap: 10px;">
                                <div class="color-box" style="width: 20px; height: 20px; background-color: rgba(54, 162, 235, 0.6);"></div>
                                <span>Perempuan: <?php echo $cewe; ?>%</span>
                            </div>
                        </div>
          </div>
        </div>
          ...
          <div class="card ">
            <div class="card-body p-3">
              <div class="bg-gradient-dark border-radius-lg">
                  <h5 class="text-white p-2">Total Data : <?php echo $dataLength; ?></h5>
              </div>
              <h4 class="ms-2 mt-3 mb-0 text-center  font-weight-bolder"> Peringatan </h4>
              <div class="p-2 bg-white rounded-3">
                        <?php if($jumlahDataTidakLengkap > 0): ?>
                        <div class="rounded-2 p-1" style="border: 1px solid black;">
                            <div class="d-flex justify-content-between mt-2"><h5 style="color: red; font-family: 'Balsamiq Sans', cursive;"><?php echo $jumlahDataTidakLengkap; ?> Data tidak lengkap</h5> <h5 id="view" style="cursor: pointer; font-family: 'Balsamiq Sans', cursive;">view</h5></div>
                            <!-- MODAL -->
                            <div id="myModal" class="modal">
                                <div class="modal-content">
                                    <span class="close">&times;</span>
                                    <?php foreach($dataTidakLengkap as $id => $details): ?>
                                    <p><a href="detail.php?id=<?php echo $id; ?>"><?php echo $details['nik']; ?></a> di bagian <?php echo $details['unit']; ?></p>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                            <!-- END MODAL -->
                        ...
                        <?php endif; ?>
                        <?php if($tahunGuru > 0): ?>
                            <div class="rounded-2 p-1 mt-3" style="border: 1px solid black;">
                            <div class="d-flex justify-content-between mt-2"><h5 style="color: red; font-family: 'Balsamiq Sans', cursive;">Ada <?php echo $jumlahTahunGuru; ?> guru yang sudah 10 tahun</h5> <h5 id="view2" style="cursor: pointer; font-family: 'Balsamiq Sans', cursive;">view</h5></div>
                            <!-- MODAL -->
                            <div id="myModal2" class="modal">
                                <div class="modal-content">
                                    <span class="close close2">&times;</span>
                                    <?php foreach($tahunGuru as $a): ?>
                                    <p><?php echo $a; ?></p>
                                    <?php endforeach; ?>
                                </div>
                            </div>
        ...
        <div class="col-lg-7">
          <div class="card h-100">
            <div class="card-header pb-0">
              <h4 class="text-center font-weight-bolder">Statistik</h4>
            </div>
            <div class="card-body p-3">
              <div class="chart">
...
let myDoughnutChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: ['#4CAF50', '#FFC107', '#f44336', '#e91e63', '#9c27b0', '#673ab7']
        }]
    },
    options: {
        maintainAspectRatio: false, // Set to false to allow dynamic resizing
...
// When the user hovers over the "view" element, open the modal
