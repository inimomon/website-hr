...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result) {
        $action = "tambah";
        $stmt = $koneksi->prepare("INSERT INTO tb_log (action) VALUES (?)");
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/tambah.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="col-md-8 mt-4 mx-auto">
          <div class="card h-100 mb-4">
            ...
            <form id="crud" action="" method="POST" enctype="multipart/form-data">
                ...
                <input type="number" id="nik" name="nik" class="w-75"><br>

                <label for="unit">Unit:</label><br>
                <select name="unit" id="unit" class="w-75">
                ...
                <input type="text" id="jabatan" name="jabatan" class="w-75"><br>

                <label for="tanggal_mulai">Tanggal Mulai:</label><br>
                <input type="date" id="tanggal_mulai" name="tanggal_mulai" class="w-75"><br>

                <label for="status_karyawan">Status Karyawan:</label><br>
                <input type="text" id="status_karyawan" name="status_karyawan" class="w-75"><br>

                <label for="tempat_lahir">Tempat Lahir:</label><br>
                <input type="text" id="tempat_lahir" name="tempat_lahir" class="w-75"><br>

                <label for="tanggal_lahir">Tanggal lahir:</label><br>
                <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="w-75"><br>

                <label for="medical_checkup">Medical Checkup:</label><br>
                <input type="date" id="medical_checkup" name="medical_checkup" class="w-75"><br>

                <label for="status_kk">Status KK:</label><br>
                <input type="text" id="status_kk" name="status_kk" class="w-75"><br>
                ...
                $data = array(
                    ...
                    'no_npwp' => 'No NPWP',
                    'alamat_npwp' => 'Alamat NPWP',
                    'rekening_sinarmas' => 'Rekening Sinarmas',
                );
                ?>

                <label for="status_kk">NIK KTP:</label><br>
                <input type="number" id="nik_ktp" name="nik_ktp" class="w-75"><br>

                <label for="status_kk">Alamat KTP:</label><br>
                <textarea name="alamat_ktp" id="alamat_ktp" rows="3" class="w-75"></textarea><br>

                <label for="status_kk">No NPWP:</label><br>
                <input type="number" id="no_npwp" name="no_npwp" class="w-75"><br>

                <label for="status_kk">Alamat NPWP:</label><br>
                <textarea name="alamat_npwp" id="alamat_npwp" rows="3" class="w-75"></textarea><br>

                <label for="status_kk">Rekening Sinarmas:</label><br>
                <input type="number" id="rekening_sinarmas" name="rekening_sinarmas" class="w-75"><br>

                <label for="pendidikan_terakhir">Pendidikan Terakhir:</label><br>
                <select name="pendidikan_terakhir" id="pendidikan_terakhir" class="w-75">
                    <option value="tk">TK</option>
                    <option value="sd">SD</option>
                    <option value="smp">SMP</option>
                    <option value="sma">SMA</option>
                ...
                <input type="text" name="jurusan" id="jurusan" class="w-75"><br>

                <label for="alamat_sekarang">Alamat Sekarang:</label><br>
                <input type="text" id="alamat_sekarang" name="alamat_sekarang" class="w-75"><br>

                <label for="no_hp">Nomor HP:</label><br>
                <input type="number" id="no_hp" name="no_hp" class="w-75"><br>

                <label for="agama">Agama:</label><br>
                <select name="agama" id="agama" class="w-75">
                ...
                <select name="golongan_darah" id="golongan_darah" class="w-75">
                ...
                <label for="email_sekolah">Email Sekolah:</label><br>
                <input type="text" id="email_sekolah" name="email_sekolah" class="w-75"><br>

                <label for="email_pribadi">Email Pribadi:</label><br>
                <input type="text" id="email_pribadi" name="email_pribadi" class="w-75"><br>

                <label for="resan">Resan:</label><br>
                <input type="text" id="resan" name="resan" class="w-75"><br>

                <label for="sk">Surat Keputusan:</label><br>
                <input type="file" id="sk" name="sk"><br>

                <label for="bpjs_tenaga_kerja">BPJS Tenaga Kerja:</label><br>
                <input type="file" id="bpjs_tenaga_kerja" name="bpjs_tenaga_kerja"><br>

                <label for="bpjs_kesehatan">BPJS Kesehatan:</label><br>
                <input type="file" id="bpjs_kesehatan" name="bpjs_kesehatan"><br>
