...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/log.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Log</h6>
        </nav>
    ...
    <div class="col-md-10 mt-4 mx-auto">
          <div class="card h-100 mb-4">
            <div class="card-header pb-0 px-3">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="mb-0">Histori Penyuntingan</h6>
                </div>
                <div class="col-md-6 d-flex justify-content-end align-items-center">
                  <i class="far fa-calendar-alt me-2"></i>
                  <small><?php echo $bulanNow; ?> <?php echo $tahunNow; ?></small>
                </div>
              </div>
            </div>
    ...
    <ul class="list-group">
        <?php $data = runQuery("SELECT * FROM tb_log WHERE year = $tahunNow AND month = $ax AND date = $hari ORDER BY hour DESC, minute DESC LIMIT 10"); ?>
            ...
            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                ...
                ?>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span class="text-xs"><?php echo $hari; ?> <?php echo $bulanNow ?> <?php echo $tahunNow; ?>, <?php echo $hour; ?>:<?php echo $minute; ?></span>
                    </div>
                </div>
    ...
    <?php $data = runQuery("SELECT * FROM tb_log WHERE year = $tahunNow AND month = $ax AND date = $hari - 1 ORDER BY hour DESC, minute DESC LIMIT 10"); ?>
    <ul class="list-group">
        <?php foreach ($data as $d): ?>
            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
    ...
    <ul class="list-group">
    <?php $data = runQuery("SELECT * FROM tb_log WHERE year = $tahunNow AND month = $ax AND date < $kemaren AND date > 0 ORDER BY date DESC, hour DESC, minute DESC LIMIT 10"); ?>
        <?php foreach ($data as $d): ?>
            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                <?php 
