...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($result !== false && $result > 0) {
        ...
        $nik = $_POST['nik'];
        $action = "edit";
        $stmt = $koneksi->prepare("INSERT INTO tb_log (action, bagian, nik, date) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $action, $bagian, $nik, $date);
        $stmt->execute();
        $stmt->close();
...
<button id="edit" name="btnEdit" style="margin-top: 100px;">Mode Edit</button>
...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12 mt-3">
        ...
        <div class="row">
          <div class="col-xl-3">
            <img src="../img/<?= $data['sk']; ?>" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl" style="height: 180px;">
            <input type="hidden" name="skLama" value="<?= $data['sk']; ?>">
            <h5 class="text-center">SK</h5>
            <input class="btn btn-outline-primary btn-sm mb-0 w-100" type="file" id="sk" name="sk" <?php echo $disabled; ?>>
          </div>

          <div class="col-xl-3">
            <img src="../img/<?= $data['bpjs_tenaga_kerja']; ?>" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl" style="height: 180px;">
            <input type="hidden" name="bpjs_tenaga_kerjaLama" value="<?= $data['bpjs_tenaga_kerja']; ?>">
            <h5 class="text-center">BPJS Tenaga Kerja</h5>
          ...
          <div class="col-xl-3">
            <img src="../img/<?= $data['bpjs_kesehatan']; ?>" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl" style="height: 180px;">
          ...
          <div class="col-xl-3">
            <img src="../img/<?= $data['gambar']; ?>" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl" style="height: 180px;">
            <input type="hidden" name="gambarLama" value="<?= $data['gambar']; ?>">
            <h5 class="text-center">Gambar</h5>
...
<button type="submit" id="tombol" class="hide" name="update">Update Data</button>
</form>
