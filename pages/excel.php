  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/excel.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Excel</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Excel</h6>
        </nav>
            ...
            <div class="upload-container">
              <div class="border-container">
                <div class="icons fa-4x">
                  <!-- Note: If you're using Font Awesome icons, make sure to include the appropriate link or script -->
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <input type="file" id="file-upload" name="excel" style="display: none;">
                    <p>Drag and drop files here, or 
                        <a href="#" id="file-browser">browse</a> your computer.
                    </p>
                    <p id="selected-filename"></p><br>
                    <button class="btn btn-secondary" type="submit" name="import" style="display: none;">Import</button>
                </form>
